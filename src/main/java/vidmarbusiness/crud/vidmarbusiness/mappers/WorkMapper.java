...
public class WorkMapper {
    ...
    public WorkDTO toDTO(Work work) {
        ...
        return new WorkDTO(work.getId(), work.getName(), work.getCliente(), work.getAddress(), work.getServiceType(), work.getInitialDate(), work.getFinishDate());
    }
    ...
    public Work toEntity(WorkDTO workDTO) {
        ...
        work.setServiceType(workDTO.serviceType());
